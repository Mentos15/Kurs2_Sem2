...
(name= N'E_UNIVER_mdf',filename = N'D:\SQL_4_Laba\E_UNIVER.mdf',size = 5Mb, maxsize=10Mb,filegrowth=1Mb),
(name = N'E_UNIVER_ndf',filename = N'D:\SQL_4_Laba\E_UNIVER.ndf',size = 5Mb, maxsize=10Mb,filegrowth=10%),
FILEGROUP G1
(name = N'E_UNIVER11_ndf',filename = N'D:\SQL_4_Laba\E_UNIVER11.ndf',size = 10Mb, maxsize=15Mb,filegrowth=1Mb),
(name = N'E_UNIVER12_ndf',filename = N'D:\SQL_4_Laba\E_UNIVER12.ndf',size = 2Mb, maxsize=5Mb,filegrowth=1Mb),
FILEGROUP G2
(name = N'E_UNIVER21_ndf',filename = N'D:\SQL_4_Laba\E_UNIVER21.ndf',size = 5Mb, maxsize=10Mb,filegrowth=1Mb),
(name = N'E_UNIVER22_ndf',filename = N'D:\SQL_4_Laba\E_UNIVER22.ndf',size = 2Mb, maxsize=5Mb,filegrowth=1Mb)

log on
(name = N'E_UNIVER_log',filename = N'D:\SQL_4_Laba\E_UNIVER.ldf',size = 5Mb, maxsize=UNLIMITED,filegrowth=1Mb)
