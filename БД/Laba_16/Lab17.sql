...
select * from SUBJECT
--4
insert into STUDENT(IDGROUP, NAME, BDAY, INFO) values(22, 'Нистюк Ольга Александровна', '05.04.1997', 
                                                         '<студентка>
...
select * from STUDENT where NAME = 'Нистюк Ольга Александровна';
...
where NAME = 'Нистюк Ольга Александровна';
select NAME[ФИО], INFO.value('(студент/паспорт/@серия)[1]', 'char(2)')[Серия паспорта], INFO.value('(студентка/паспорт/@номер)[1]', 'varchar(20)')[Номер паспорта], INFO.query('/студентка/адрес')[Адрес] from  STUDENT where NAME = 'Нистюк Ольга Александровна';       
