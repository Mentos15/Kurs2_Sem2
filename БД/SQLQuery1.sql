...
declare KSubjects1 cursor local
				for select SUBJECT, PULPIT from SUBJECT where SUBJECT = 'БД';
open KSubjects1;
...
--task3
declare @tnm char(10);
declare SubjectK cursor local dynamic--static
	for select SUBJECT from SUBJECT where PULPIT = 'ИСиТ';
open SubjectK;
update SUBJECT set SUBJECT = 'NewSubj' where SUBJECT = 'ИНФ';
delete SUBJECT where PULPIT = 'ЛПиСПС';
