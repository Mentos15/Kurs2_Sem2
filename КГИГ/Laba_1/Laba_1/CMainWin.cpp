...
CMainWin::CMainWin()
{
	this->Create(0, (LPCTSTR)L"Hello World", WS_OVERLAPPEDWINDOW, rectDefault, 0, (LPCTSTR)IDR_MENU1);
	MenuClick = -1;
}
void CMainWin::OnPaint()
{
	...
	{
	case  ID_CMATRIX_C1:
		dc.TextOutW(100, 100, CString("A"));
		PrintMatrix(dc, 100, 120, A);
		dc.TextOutW(300, 100, CString("B"));
		PrintMatrix(dc, 300, 120, B);
		dc.TextOutW(500, 100, CString("C1 = A + B"));
		PrintMatrix(dc, 500, 120, A + B);
		break;
	case ID_CMATRIX_C2:
		dc.TextOutW(100, 100, CString("A"));
		PrintMatrix(dc, 100, 120, A);
	...
	case ID_CMATRIX_D:
		dc.TextOutW(100, 100, CString("A"));
		PrintMatrix(dc, 100, 120, A);
		dc.TextOutW(300, 100, CString("V1"));
		PrintMatrix(dc, 300, 120, V1);
		dc.TextOutW(500, 100, CString("D = A * V1"));
		PrintMatrix(dc, 500, 120, A * V1);
		break;
	case ID_CMATRIX_Q:
		dc.TextOutW(100, 100, CString("V1"));
		PrintMatrix(dc, 100, 120, V1);
		dc.TextOutW(300, 100, CString("V1^T"));
		PrintMatrix(dc, 300, 120, V1.Transp());
		dc.TextOutW(500, 100, CString("V2"));
		PrintMatrix(dc, 500, 120, V2);
		dc.TextOutW(700, 100, CString("q = V1^T * V2"));
		PrintMatrix(dc, 700, 120, V1.Transp() * V2);
		break;
	case ID_CMATRIX_P:
		dc.TextOutW(100, 100, CString("V1"));
		PrintMatrix(dc, 100, 120, V1);
		dc.TextOutW(200, 100, CString("V1^T"));
		PrintMatrix(dc, 200, 120, V1.Transp());
		dc.TextOutW(400, 100, CString("A"));
		PrintMatrix(dc, 400, 120, A);
		dc.TextOutW(600, 100, CString("V2"));
		PrintMatrix(dc, 600, 120, V2);
		dc.TextOutW(700, 100, CString("q = V1^T * A * V2"));
		PrintMatrix(dc, 700, 120, V1.Transp() * A * V2);
		break;
